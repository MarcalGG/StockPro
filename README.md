...
- Escanear o codigo de barras (EAN) de cada produto durante a conferencia fisica para incrementar a quantidade recebida sem digitar (reaproveitaria o mesmo scanner de camera que ja existe).
